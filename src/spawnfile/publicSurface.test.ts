...
test("spawnfile public surface is the exact neutral external-consumer contract", async () => {
  ...
  try {
    ...
    await writeFile(sourcePath, [
      ...
      '// @ts-expect-error bootstrap identity is internal to composed bootstrap',
      'import type { BootstrapSpawnfileCliContext } from "simfile/spawnfile";',
      ...
      '// @ts-expect-error bootstrap identity is not part of the public context',
      'const bootstrapContext: SpawnfileCliContext = { bootstrapLocalExecutableIdentity: {}, spawnfileBin: "spawnfile.mjs" };',
      ...
      'void [context, bootstrapContext, up, exported, down, upReceipt, downReceipt, preparationRequest, preparationInput, preparationReceipt];',
