...
export const matrix: CoverageRow[] = [
  // Frozen top-level rows.
  {
    ...
    specRef: "docs/SYSTEMS_VIEW.md#every-top-level-key",
    status: "implemented",
  ...
  },
  {
    ...
    specRef: "docs/DESIGN.md#variables",
    status: "implemented",
    evidence: "src/runtime/trace.test.ts"
  },
  {
  ...
  },
  {
    ...
    specRef: "docs/DESIGN.md#generators",
    status: "implemented",
    evidence: "src/runtime/trace.test.ts"
  },
  {
  ...
  },
  {
    ...
    specRef: "docs/DESIGN.md#events-and-ledger",
    status: "implemented",
    evidence: "src/runtime/run-record.test.ts"
  },
  {
    ...
    specRef: "docs/SYSTEMS_VIEW.md#ledger",
    status: "deferred",
  ...
  },
  {
    ...
    specRef: "docs/SYSTEMS_VIEW.md#telemetry--markers",
    status: "implemented",
    evidence: "src/runtime/run-record.test.ts"
  },
  {
